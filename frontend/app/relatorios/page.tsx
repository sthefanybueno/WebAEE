...
const CATEGORIAS = [
  { icon: '📋', title: 'PDIs', subtitle: 'Planos individuais de desenvolvimento', badge: '5 pendentes', badgeVariant: 'danger' as const },
  { icon: '📝', title: 'Relatórios Diários', subtitle: 'Registro cotidiano em sala de recurso', badge: '12 revisão', badgeVariant: 'warning' as const },
  { icon: '📊', title: 'Relatórios Trimestrais', subtitle: 'Consolidado trimestral de metas', badge: 'Em dia ✓', badgeVariant: 'success' as const },
]
    ...
    >
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        <div>
          ...
          <p className="text-[15px] text-[--color-text-secondary]">Gerencie a documentação dos seus alunos do AEE.</p>
        </div>

        {/* Alert pendências críticas */}
