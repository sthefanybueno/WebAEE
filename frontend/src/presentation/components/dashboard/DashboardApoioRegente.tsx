  ...
  return (
    <div className="max-w-[1160px] mx-auto px-6 py-9 flex flex-col gap-8">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h2 className="text-2xl font-extrabold tracking-tight text-gray-900">Olá! 👋</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        >
          ...
          {meuAluno ? (
            <>
              <p className="text-lg font-extrabold text-gray-900 leading-tight">{meuAluno.nome}</p>
              <p className="text-sm font-medium text-gray-500 mt-1">Meu Aluno</p>
            </>
          ) : (
            <>
              <p className="text-3xl font-extrabold text-gray-900 leading-none">{alunos?.length ?? 0}</p>
              <p className="text-sm font-medium text-gray-500 mt-1">Alunos</p>
            </>
          )}
        </Link>
        ...
        >
          ...
          <p className="text-3xl font-extrabold text-gray-900 leading-none">—</p>
          <p className="text-sm font-medium text-gray-500 mt-1">Relatórios</p>
        </Link>
      </div>
