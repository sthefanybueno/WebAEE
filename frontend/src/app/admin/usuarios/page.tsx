    ...
    <AppShell
      ...
      header={
        <>
          ...
          <h1 className="text-[18px] font-bold text-[--color-text-primary]">Cadastro de UsuÃ¡rios</h1>
          <button onClick={() => setModal(true)} aria-label="Convidar usuÃ¡rio"
    ...
    >
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        <div className="flex items-end justify-between">
          <div>
            <h2 className="text-[22px] font-bold text-[--color-text-primary]">UsuÃ¡rios</h2>
          ...
          {USUARIOS_MOCK.map((u) => (
            <div key={u.id}
              ...
              <div className="flex-1 min-w-0">
                ...
                {u.status === 'pendente' && (
                  <p className="text-[12px] font-bold text-[--color-status-warning]">â³ Convite pendente</p>
                )}
              </div>
              ...
              <button aria-label="Mais opÃ§Ãµes" className="p-2 rounded-full hover:bg-[--color-surface] transition-colors shrink-0">
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[60] flex items-end md:items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-[18px] font-bold text-[--color-text-primary]">Convidar UsuÃ¡rio</h3>
